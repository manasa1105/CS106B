...
private:
   ...
   /* Private methods */
      ...
      int SwapPos(int pos);
      int smallerChildNode(int left, int right);
      int NumberOfChildren(int pos);
      void checkChildren(int pos);
      void checkParent(int pos);
      /*
      int get_swap_pos(int pos);
      int get_num_children(int pos);
      int get_smaller_node(int posA, int posB);
      */
